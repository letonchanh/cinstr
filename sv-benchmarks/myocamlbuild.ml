(* OASIS_START *)
(* DO NOT EDIT (digest: 173646491ea8dc6735476d8d38f86001) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_executable_instr_byte"; "ocaml"; "link"; "byte"],
            [
          ...
          (["oasis_executable_instr_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_instr_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_instr_native"; "ocaml"; "ocamldep"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_instr_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_instr_native"; "ocaml"; "compile"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
