...
(* OASIS_START *)
(* DO NOT EDIT (digest: 783c0a1976f66f2f9b9431deccdd7440) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreater "4.01.0");
          version = "0.1";
          license =
          ...
          description =
            Some [OASISText.Para "C Instrumentation for SV-COMP benchmarks"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "instr.ml"})
            ];
     ...
     oasis_digest = Some "\205@\027w\230H[\141N\209\222\193k\180\243n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
